...
🔍 SQL queries? Check them out here: [project_sql folder](/SQL-Project-Data-Jobs-Analysis/project_sql//)

# Background

Driven by a quest to navigate the data analyst job market more effectively, this project was born from a desire to pinpoint top-paid and in-demand skills, streamlining others work to find optimal jobs.

Data hails from my project. It's packed with insights on job titles, salaries, locations, and essential skills.
...
![Top Paying Roles](/SQL-Project-Data-Jobs-Analysis/assets/1_top_paying_roles.png)
...
![Top Paying Skills](/SQL-Project-Data-Jobs-Analysis/assets/2_top_paying_roles_skills.png)
